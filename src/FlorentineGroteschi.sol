...
/// @title Florentine Groteschi
/// @notice OpenSea SeaDrop-compatible ERC721 for the Florentine Groteschi collection.
/// @dev Primary minting should happen through an allowed SeaDrop contract. Includes the project-required agent burn path.
contract FlorentineGroteschi is ERC721, ERC2981, Ownable, ReentrancyGuard, INonFungibleSeaDropToken {
    ...
    constructor(address owner_, address payoutWallet_, uint96 royaltyBps_, address[] memory allowedSeaDrop_)
        ERC721("Florentine Groteschi", "FGROT")
        Ownable(owner_)
    {
